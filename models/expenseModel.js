...
const expenseModel = new Schema(
  {
    amount: {type: String},                   //Amount ok $$ being expended
    ...
    numberOfInstallments: {type: String},     //Numero de cuotas
    ...
    description: {type: String},              //Description og the expense: "Dinner we have at La Posada"
  },
